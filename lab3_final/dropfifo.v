...
// /___/   /\     Timestamp : 01/31/2026 01:48:35
// \   \  /  \ 
//  \___\/\___\ 
//
//Command: C:\Xilinx\10.1\ISE\bin\nt\unwrapped\sch2verilog.exe -intstyle ise -family virtex2p -w "C:/Documents and Settings/student/Desktop/lab3_final/dropfifo.sch" dropfifo.vf
...
module dropfifo(clk, 
   ...
   COMP8_MXILINX_dropfifo XLXI_5 (.A(FD8CE_D[7:0]), 
                                  .B(addrb[7:0]), 
                                  .EQ(XLXN));
   // synthesis attribute HU_SET of XLXI_5 is "XLXI_5_18"
   COMP8_MXILINX_dropfifo XLXI_6 (.A(addrb[7:0]), 
                                  .B(FD8CEO0[7:0]), 
                                  .EQ(XLXN_78));
   ...
   OR2 XLXI_21 (.I0(FDLASO), 
                .I1(XLXN_66), 
                .O(XLXN_40));
   AND2B1 XLXI_22 (.I0(FDO), 
                   .I1(XLXN_40), 
                   .O(XLXN_95));
   AND3B2 XLXI_23 (.I0(XLXN_78), 
                   .I1(XLXN), 
                   .I2(fiforead), 
                   .O(XLXN_112));
   VCC XLXI_24 (.P(XLXN_201));
   reg9B XLXI_26 (.ce(XLXN_201), 
                  .clk(clk), 
                  .clr(rst), 
                  .d(in_fifo[71:0]), 
                  .q(dina[71:0]));
   ...
   dualportmemory XLXI_28 (.addra(FD8CE_D[7:0]), 
                           .addrb(addrb[7:0]), 
                           .clka(clk), 
                           .clkb(clk), 
                           .dina(dina[71:0]), 
